...
public final class Worker implements Constants {
    ...
    private static FileObject getPemCover() {
        URL url = Worker.class.getResource("../res/cover.png");   // from jem-formats
        if (url != null) {
    ...
    static boolean setAttributes(Chapter part, Map<String, Object> attributes) {
        for (String key: attributes.keySet()) {
            String raw = String.valueOf(attributes.get(key));
            Object value = null;
            if (Chapter.COVER.equals(key)) {
                FileObject cover;
                ...
                value = TextFactory.fromString(raw);
            } else {
                value = raw;
            }
            if (value != null) {
    ...
    private static void walkTree(Chapter part,
                                 String prefix,
                                 String[] keys,
    ...
    private static void viewToc(Chapter part,
                                String[] keys,
                                String indent,
    ...
    private static void viewPart(Chapter part,
                                 String[] keys,
                                 String sep,
        ...
        for (String key: keys) {
            if (key.equals(VIEW_KEY_ALL)) {
                ...
                viewToc(part, new String[]{Chapter.TITLE, Chapter.COVER},
                        AppConfig.getInstance().getTocIndent(), true, true);
