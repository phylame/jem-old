...
package pw.phylame.jem.formats.meb;
...
/**
 * MEB parser implement for Jem.
 */
public class MebMaker implements Maker {
    ...
    public void make(Book book, File file, Map<String, Object> kw)
        ...
        throw new MakerException("under development", getName());
    }
