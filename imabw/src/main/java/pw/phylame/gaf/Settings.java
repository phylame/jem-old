...
public class Settings {
    ...
    public static final String SETTINGS_FILE = Application.getUserHome() + "/settings.pfc";
        ...
        try {
            ...
            if (in != null) {
                try {
                    ...
                    LOG.debug("close settings failed: " + SETTINGS_FILE, e);
                }
            }
        }
    }
    ...
    public void sync() {
        ...
        try {
            ...
            LOG.debug("save settings failed: " + SETTINGS_FILE, e);
        } finally {
            if (out != null) {
                try {
                    out.close();
