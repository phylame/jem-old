...
public abstract class UndoContentsInserting extends UndoTask {
    protected ContentsUndoQueue undoQueue;

    public UndoContentsInserting(ContentsUndoQueue undoQueue, String message) {
        super(message);
        this.undoQueue = undoQueue;
    }

    protected void deInserting() {
        undoQueue.doRemoving(false, false);
    }
