...
public class RedoContentsRemoving extends RedoTask {
    protected ContentsUndoQueue undoQueue;

    public RedoContentsRemoving(ContentsUndoQueue undoQueue, String message) {
        super(message);
        this.undoQueue = undoQueue;
    }

    protected void doRemoving() {
        undoQueue.doRemoving(true, true);
    }
    ...
    protected void redo() {
        ...
        undoQueue.getUndoManager().newUndoRemoveChapters(undoQueue, getMessage());
    }
}
