...
public class UndoJoinChapters extends UndoContentsRemoving {
    private ContentsUndoItem insertedItem;

    public UndoJoinChapters(ContentsUndoItem insertedItem,
    ...
    protected void undo() {
        ...
        deRemoving();
        undoQueue.removeItem(insertedItem, false);
        undoQueue.resetPreviousSelections();
        undoQueue.selections = selections;
        setRelatedRedoTask(new RedoJoinChapters(insertedItem, undoQueue, getMessage()));
    }
}
