...
public class PmabMacProvider extends JDialog implements MacProvider {
    ...
    public PmabMacProvider(Frame owner, String title) {
        super(owner, title, true);
        init();
    }

    public PmabMacProvider(Dialog owner, String title) {
        super(owner, title, true);
        init();
    }
