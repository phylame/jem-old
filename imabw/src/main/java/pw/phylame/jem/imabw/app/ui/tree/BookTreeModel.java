...
class BookTreeModel implements TreeModel {
    ...
    static boolean isRoot(Chapter chapter) {
        return chapter.getParent() == null;
    }

    static Chapter[] getPathToRoot(Chapter chapter) {
        ...
        return paths.toArray(new Chapter[0]);
    }

    BookTreeModel(NavigateTree bookTree, Chapter book) {
        this.bookTree = bookTree;
        this.book = book;
    }

    void setBook(Chapter book) {
        if (book == null) {
    ...
    public Object getChild(Object parent, int index) {
        return ((Chapter) parent).get(index);
    }
    ...
    public void valueForPathChanged(TreePath path, Object newValue) {
        ...
        if (!chapter.getTitle().equals(newValue)) {
            HashMap<String, Object> newAttr = new HashMap<>();
            newAttr.put(Chapter.TITLE, newValue);
            bookTree.updateChapterAttributes(chapter, newAttr,
                    Imabw.getInstance().getText("Undo.Message.RenameChapter"));
        }
    }
     ...
     */
    void chaptersInserted(Chapter parent, int[] indices, Chapter[] children) {
     ...
     */
    void chaptersRemoved(Chapter parent, int[] indices, Chapter[] children) {
     ...
     */
    void chapterUpdated(Chapter parent, int[] indices, Chapter[] children) {
        if(parent != null) {
    ...
    void chapterUpdated(Chapter chapter) {
     ...
     */
    void childrenChanged(Chapter parent) {
        if(parent != null) {
 ...
 *             {@code null} to identify the root has changed
     ...
     */
    protected void fireChapterUpdated(Object source, Chapter[] path,
     ...
     */
    protected void fireChaptersInserted(Object source, Chapter[] path,
                                        int[] indices, Chapter[] children) {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        TreeModelEvent e = null;
     ...
     */
    protected void fireChaptersRemoved(Object source, Chapter[] path,
                                       int[] indices, Chapter[] children) {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        TreeModelEvent e = null;
     ...
     */
    protected void fireChildrenChanged(Object source, Chapter[] path,
                                       int[] indices, Chapter[] children) {
        // Guaranteed to return a non-null array
        Object[] listeners = listenerList.getListenerList();
        TreeModelEvent e = null;
